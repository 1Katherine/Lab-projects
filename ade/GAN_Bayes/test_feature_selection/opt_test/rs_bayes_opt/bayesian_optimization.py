...
from .tools import standardization,reverse_standardization,normalization,reverse_normalization
...
class BayesianOptimization(Observable):
    ...
    def suggest(self, utility_function):
        ...
        with warnings.catch_warnings():
            ...
            # self._gp.fit(self._space.params.tolist(), self._space.target)
        ...
        # print('np.percentile(self._space.target, 25) = ' + str(np.percentile(self._space.target, 25)))
        # print('Tconstraint = ' + str(str(np.percentile(self._space.target, 25))))
    ...
    def maximize(self,
        ...
        print('迭代结束条件，当执行时间低于Tmax时，停止搜索，此时对应优化倍数为'+ str(xtimes) +'倍。Tmax = ' + str(Tmax))
        ...
        while not self._queue.empty or iteration < n_iter:
            ...
            print('x = ' + str(x))
            print('interations = ' + str(iteration))
