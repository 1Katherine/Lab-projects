...
echo $path
# $1 = wordcount-100G
echo "=============== start $1 ===============" >> $path/direct_ganrs_Bayesian_cycle.log
echo $(date) >> $path/direct_ganrs_Bayesian_cycle.log
echo "=============== start $1 ===============" >> $path/direct_ganrs_Bayesian_cycle.log

startTime=$(date "+%m-%d-%H-%M")
mv  $path/config/$1 $path/config/$1-$startTime
mv $path/logs* $path/config/$1-$startTime
mv $path/generationConf* $path/config/$1-$startTime
mv $path/target* $path/config/$1-$startTime
...
mv $path/generationConf* $path/config/$1-$finishTime
mv $path/target* $path/config/$1-$finishTime
...
echo "=============== finish $1 ===============" >> $path/direct_ganrs_Bayesian_cycle.log
echo $(date) >> $path/direct_ganrs_Bayesian_cycle.log
echo "=============== finish $1 ===============" >> $path/direct_ganrs_Bayesian_cycle.log
mv $path/direct_ganrs_Bayesian_cycle.log $path/direct_ganrs_Bayesian_cycle-$finishTime.log
