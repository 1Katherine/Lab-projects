...
def clear(totalNum):
    for i in range(totalNum):
        print('============' + opts.benchmark + '/co-' + str(i + 1) + '-report.csv' + '============')
        fileNameStr = '/home/collect/csv/before_clear/container/' + opts.benchmark + '/comon-' + str(i + 1) + '.csv'
        df = pd.read_csv(fileNameStr)
        clear_data(df, '/home/collect/csv/after_clear/container/' + opts.benchmark + '/co-' + str(i + 1) + '-report.csv')
