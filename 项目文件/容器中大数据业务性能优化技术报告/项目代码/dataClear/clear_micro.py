...
def clear(totalNum):
    for i in range(totalNum):
        print('============' + opts.benchmark + '/micro-' + str(i + 1) + '-report.csv' + '============')
        fileNameStr1 = '/home/collect/csv/before_clear/micro/node02/' + opts.benchmark + '/pfmon-' + str(i + 1) + '-k8s-node02.csv'
        fileNameStr2 = '/home/collect/csv/before_clear/micro/node03/' + opts.benchmark + '/pfmon-' + str(i + 1) + '-k8s-node03.csv'
        df = merge_nodes(fileNameStr1, fileNameStr2)
        clear_data(df, '/home/collect/csv/after_clear/micro/' + opts.benchmark + '/micro-' + str(i + 1) + '-report.csv')
